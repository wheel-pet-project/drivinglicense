...
public class GetAllDrivingLicensesQueryHandlerShould : IntegrationTestBase
{
    ...
    [
        DrivingLicense.Create(Guid.NewGuid(), CategoryList.Create([CategoryList.BCategory]),
            ...
            TimeProvider.System),
        DrivingLicense.Create(Guid.NewGuid(), CategoryList.Create([CategoryList.BCategory]),
            DrivingLicenseNumber.Create("1234 567892"), Name.Create("Иван", "Иванов", "Иванович"),
            City.Create("Москва"),
    ...
    private class QueryHandlerBuilder
    {
        ...
        public GetAllDrivingLicensesQueryHandler Build()
        {
            return new GetAllDrivingLicensesQueryHandler(_dataSource);
        }
