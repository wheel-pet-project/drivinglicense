...
namespace UnitTests.Core.Application.Commands.ApproveDrivingLicense;
...
public class ApproveDrivingLicenseHandlerShould
{
    ...
    private readonly ApproveDrivingLicenseRequest _request = new(Guid.NewGuid(), Guid.NewGuid());
